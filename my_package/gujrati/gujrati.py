...
async def gujrati_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [
            InlineKeyboardButton("KVK", callback_data='1.8'),
    ...
    await context.bot.send_message(chat_id=update.effective_chat.id, text="GUJRATI LANGUAGE",reply_markup=reply_markup)
